package com.coolappstore.everhaptics.by.svhp.edge
...
object EdgeHapticsBridge {
    ...
    fun testEdgeHaptic(context: Context): TestResult {
        ...
        return try {
            ...
            vibrator.vibrate(buildEdgeEffect(com.coolappstore.everhaptics.by.svhp.haptics.HapticPattern.TICK, 0.5f), attrs)
            TestResult.Fired
        } catch (_: Throwable) {
