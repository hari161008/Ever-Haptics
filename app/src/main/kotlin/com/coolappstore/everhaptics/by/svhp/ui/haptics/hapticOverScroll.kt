...
package com.coolappstore.everhaptics.by.svhp.ui.haptics
...
fun ProvideHapticksEdgeOverscrollHaptics(content: @Composable () -> Unit) {
    ...
    val factory = remember(baseFactory, engine, settings.scrollIntensity) {
        HapticInstrumentedOverscrollFactory(baseFactory, engine, settings.scrollIntensity)
    }
...
fun Context.performAppEdgeOverscrollHaptic() {
    ...
    app.hapticEngine.play(
        ...
        intensity = snapshot.scrollIntensity,
        throttleMs = 0L,
    )
}